 ...
 *
 */
public class Spine2ParameterB<B extends Data,O extends Data> implements Spine<B, O> {
	private B data; //store the data
	/**
	 * @return the data
	 */
	public B getData() {
	...
	private Spine2<? extends Data,B,O> delegate;

	public Spine2ParameterB(Spine2<? extends Data,B,O> delegate){
	 ...
	 */
	@Override
	public Spine<B, O> flowsInto(Spine<O, ? extends Data> child) {
	 ...
	 */
	@Override
	public void flowsFrom(Spine<? extends Data, B> parent) {
		delegate.flowsFromB(parent);
	}
	/* (non-Javadoc)
	 * @see com.cecere.forkupine.process.Spine#getPrevNode()
	 */
	@Override
	public Spine<? extends Data, B> getPrevNode() {
	 ...
	 */
	@Override
	public RecursiveSpineImpl<B, O> toRecursiveSpine() {
		// TODO Auto-generated method stub
		return null;
	}
